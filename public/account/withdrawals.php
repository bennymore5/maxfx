                    ...
                    <div class="dt-header__container">
                        ...
                        <div class="dt-header__toolbar">
                            ...
                            <div class="search-box d-none d-lg-block">
                                                            <form method="post">
                                                                    <input type="hidden" name="csrf_test_name" value="571bacb31cddf77185fd0739b35cea65" />
...
<div class="dt-content-wrapper">
        ...
        <div class="profile">
            ...
            <div class="profile__banner">
                ...
                <div class="dt-page__header">
                    ...
                    Withdrawals                    </h1>
                                                                    <a href="https://bitrally.top/withdrawals/new" class="btn btn-light btn-sm display-i ft-right">Make a withdrawal</a>
                            ...
                            <!-- Card Body -->
                                ...
                                <div class="table-responsive dataTables_wrapper dt-bootstrap4">
                                    <div class="table-responsive">
                                            ...
                                            <img src="https://bitrally.top/assets/dist/img/no-search-results.png" class="w-20rm">
    ...
    <div class="modal fade display-n" id="modal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <!-- Modal Content -->
            <div class="modal-content">
                <form action="https://bitrally.top/" id="modalForm" method="post" accept-charset="utf-8">
                 <input type="hidden" name="csrf_test_name" value="571bacb31cddf77185fd0739b35cea65" />
                    <!-- Modal Header -->
                    <div class="modal-header">
    ...
    <!-- /modal -->
    <script src="https://bitrally.top/assets/dist/js/trans.js"></script>
    <script>
